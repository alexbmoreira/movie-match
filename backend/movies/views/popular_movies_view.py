...
class PopularMoviesAPIView(APIView):
    ...
    def get(self, request):
        ...
        cached = TmdbAPIView.is_cached(request, 'popular', page=page)

        if not cached:
            movies = TmdbListAPIView.make_request('movie/popular', page=page)
            ...
            TmdbAPIView.set_cache(request, 'popular', movies, page=page)
