...
describe FriendRequests::List do
  ...
  let!(:friend_request2) { create(:friend_request, receiver: creator, creator: other_user) }
  let!(:friend_request3) { create(:friend_request, creator: creator, receiver: other_user) }
