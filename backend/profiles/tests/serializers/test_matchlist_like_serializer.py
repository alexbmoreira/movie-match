...
from profiles.serializers import MatchlistLikeSerializer
...
class MatchlistLikeSerializerTests(TestCase):
    ...
    def setUp(self):
        ...
        self.serializer = MatchlistLikeSerializer(data=self.data, context={'request': self.request, 'user_id': self.friend.id}) 
